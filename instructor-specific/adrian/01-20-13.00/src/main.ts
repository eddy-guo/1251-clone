...
import { myhappwidget } from "./myhappywidget"
...
setSKEventListener(ev => {
    if (ev.type === "mousemove") {
        ...
        const mev = ev as SKMouseEvent
        widgets.forEach(widget => widget.mousedblclk(mev.x, mev.y))
...
widgets.push(new myhappwidget(200, 200))
widgets.push(new myhappwidget(450, 350))
