...
// array of 2D points
const housePoints: [number, number][] = [
  [40, 0],
  [80, 40],
  [80, 100],
  [0, 100],
...
function fpsDemo(gc: CanvasRenderingContext2D) {
  gc.font = "32pt sans-serif";
  // current FPS with some exponential smoothing
  // skTime is current time in ms since page load (from SimpleKit)
  fps = 0.98 * fps + 0.02 * Math.round(1000 / (skTime - lastTime));
